...
local DUNGEON_KEYWORDS = {
    ...
    "hour of twilight","karazhan crypt",
    "mythic", "mythic+", "keystone"
}

-- ==================== ACTIVITY FILTER DATABASE ====================
...
function LFG.InitRowPool(parent)
    ...
    for i = 1, MAX_DISPLAY_ROWS do
        ...
        -- Invisible button over nameText for right-click
...
function LFG:Initialize(parentFrame)
    ...
    lfgToggle.track:SetColorTexture(0.7, 0.15, 0.1, 1)
    ...
    lfgToggle.trackBorder:SetColorTexture(0.2, 0.2, 0.2, 1)
    ...
    lfgToggleLabel:SetTextColor(0.7, 0.7, 0.7)

    local function UpdateToggleVisual(isOn)
        if isOn then
            lfgToggle.track:SetColorTexture(0.2, 0.75, 0.15, 1) -- Green ON
            lfgToggle.knob:ClearAllPoints()
            lfgToggle.knob:SetPoint("CENTER", lfgToggle, "RIGHT", -knobSize / 2, 0)
            lfgToggleLabel:SetTextColor(0.2, 0.85, 0.2)
        else
            lfgToggle.track:SetColorTexture(0.7, 0.15, 0.1, 1) -- Red OFF
            lfgToggle.knob:ClearAllPoints()
            lfgToggle.knob:SetPoint("CENTER", lfgToggle, "LEFT", knobSize / 2, 0)
            lfgToggleLabel:SetTextColor(0.8, 0.3, 0.3)
        end
    end
    ...
    filterBtn.bg:SetColorTexture(0.1, 0.15, 0.25, 0.6)
    ...
    filterBtn.border:SetColorTexture(0.3, 0.5, 0.7, 0.5)
    ...
    local function UpdateFilterIconState()
        ...
        if unchecked > 0 then
            filterBtn.border:SetColorTexture(0.9, 0.6, 0.1, 0.9)
            filterBtn.bg:SetColorTexture(0.2, 0.12, 0.05, 0.7)
        else
            filterBtn.border:SetColorTexture(0.3, 0.5, 0.7, 0.5)
            filterBtn.bg:SetColorTexture(0.1, 0.15, 0.25, 0.6)
        end
    ...
    filterBtn:SetScript("OnEnter", function(self)
        self.border:SetColorTexture(0.5, 0.7, 1, 0.9)
