...
local function touchUser(self, name, seen)
    local pn = UnitName("player") or ""
    if name == pn then return nil end
...
local function notifyUserAdded(self)
...
function Presence:HandlePong(name, seen)
    ...
    local isNew = not self.onlineUsers[name]
    local u = touchUser(self, name, seen)
    if isNew and u then
        notifyUserAdded(self)
    end
end
...
function Presence:HandlePresence(user)
    ...
    if user.version and user.version ~= "" and user.version ~= myVersion then
        user.outdated = (self:CompareVersions(user.version, myVersion) < 0)
    else
        user.outdated = false
    end
...
function Presence:GetStats(optRows)
    local rows = optRows or self:GetOnlineUsers()
    local stats = {
        total = #rows,
        friends = 0,
        tanks = 0,
...
function Presence:BuildPanel(parent)
    ...
    headerFrame.title = headerFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalLarge")
    headerFrame.title:SetPoint("LEFT", headerFrame, "LEFT", 14, 2)
    headerFrame.title:SetText("|cff88ccffFrost|r|cffffffffNet|r")
    f.onlineBadge = headerFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormal")
    ...
    f.statusText = statusBtn:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    for idx, opt in ipairs(STATUS_OPTIONS) do
        ...
        btn.label = btn:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
        btn.label:SetPoint("LEFT", btn.dot, "RIGHT", 6, 0)
        btn.label:SetText(opt.hex .. opt.label .. "|r")

        btn.check = btn:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.statsLeft = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    local barH = 6
    local barGap = 11
    local tankLabel = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.tankCount = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    f.tankCount:SetPoint("LEFT", f.tankBarBg, "RIGHT", 4, 0)
    f.tankCount:SetText("0")
    f.tankCount:SetTextColor(unpack(_tc("textDim")))

    local healerLabel = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.healerCount = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    f.healerCount:SetPoint("LEFT", f.healerBarBg, "RIGHT", 4, 0)
    f.healerCount:SetText("0")
    f.healerCount:SetTextColor(unpack(_tc("textDim")))

    local dpsLabel = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.dpsCount = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    f.dpsCount:SetPoint("LEFT", f.dpsBarBg, "RIGHT", 4, 0)
    f.dpsCount:SetText("0")
    f.dpsCount:SetTextColor(unpack(_tc("textDim")))

    local supportLabel = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.supportCount = statsFrame:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    local searchLabel = toolbar:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    searchLabel:SetPoint("TOPLEFT", toolbar, "TOPLEFT", 0, -8)
    searchLabel:SetText(_hex("textDim") .. L["search"] .. ":|r")
    f.searchEdit = CreateFrame("EditBox", nil, toolbar)
    f.searchEdit:SetAutoFocus(false)
    f.searchEdit:SetFontObject("FSKFontNormalSmall")
    ...
    roleBtn.text = roleBtn:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    local sortLabel = toolbar:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    sortLabel:SetPoint("TOPLEFT", toolbar, "TOPLEFT", 120, -35)
    sortLabel:SetText(_hex("textDim") .. L["presence_sort"] .. ":|r")
    ...
    guildToggle.text = guildToggle:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    local function UpdateGuildToggleText()
        if Presence.guildOnly then
            ...
            guildToggle.text:SetText("|cff888888" .. L["presence_guild_only"] .. ": OFF|r")
        end
    end
    ...
    for i = 1, VISIBLE_ROWS do
        ...
        r.level = r:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
        ...
        r.zone = r:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
        r.zone:SetPoint("LEFT", r, "LEFT", 230, 0)
        r.zone:SetWidth(95)
        r.zone:SetJustifyH("LEFT")

        r.guild = r:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
        r.guild:SetPoint("LEFT", r, "LEFT", 330, 0)
        r.guild:SetWidth(100)
        r.guild:SetJustifyH("LEFT")

        r.seen = r:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.autoLabel = f:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    f.versionLabel = f:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
...
function Presence:RefreshPanel()
    ...
    local rows = self:GetOnlineUsers()
    local stats = self:GetStats(rows)
    local f = self.panel
...
function Presence:ShowFavoriteToast(name, role, level)
    ...
    toast.title = toast:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
    ...
    toast.body = toast:CreateFontString(nil, "OVERLAY", "FSKFontNormalSmall")
...
function Presence:ShowRowContextMenu(userData)
    ...
    if Presence._ctxMenu then
        if Presence._ctxMenu.closer then Presence._ctxMenu.closer:Hide() end
