...
function Community:BuildEventBoardFrame()
    ...
    local header = ef:CreateFontString(nil, "OVERLAY", "GameFontNormal")
    header:SetPoint("TOPLEFT", ef, "TOPLEFT", 0, 0)
    header:SetText(_hex("textDim") .. L["event_board_discovered"] .. "|r")
    curY = -20

    local filterLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local myLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    for i = 1, 30 do
        ...
        row.hostText = row:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
        row.hostText:SetPoint("TOPLEFT", row, "TOPLEFT", 380, -4)
        row.hostText:SetWidth(110)

        row.expiresText = row:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
        row.expiresText:SetPoint("TOPLEFT", row, "TOPLEFT", 495, -4)
        row.expiresText:SetWidth(60)

        row.descText = row:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local typeLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    typeBtn.text = typeBtn:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local expiresLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    expiresBtn.text = expiresBtn:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    local timeLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    if UI and UI.CreateModernEditBox then
        ...
        self.eventTime:SetFontObject("GameFontNormalSmall")
    ...
    local hostLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    if UI and UI.CreateModernEditBox then
        ...
        self.eventHost:SetFontObject("GameFontNormalSmall")
    ...
    if UI and UI.CreateModernEditBox then
        ...
        self.eventContact:SetFontObject("GameFontNormalSmall")
    ...
    local descLabel = ef:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    ...
    if UI and UI.CreateModernEditBox then
        ...
        self.eventDesc:SetFontObject("GameFontNormalSmall")
    ...
    postBtn.text = postBtn:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
