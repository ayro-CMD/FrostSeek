...
function Profile:Initialize(parentFrame)
    ...
    for i, role in ipairs(roles) do
        ...
        btn:SetSize(110, 28)
        btn:SetPoint("TOPLEFT", F, "TOPLEFT", pad + (i - 1) * 120, curY)
...
local function RegisterProfileModule()
    if not _G.FrostSeek then
        C_Timer.After(0.5, RegisterProfileModule)
        return
    end
