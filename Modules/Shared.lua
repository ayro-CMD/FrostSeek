...
function Shared.ConfirmDialog(title, text, onConfirm, onCancel)
    ...
    frame.text = frame:CreateFontString(nil, "OVERLAY", "FSKFontNormal")
    ...
    frame.confirmBtn.text = frame.confirmBtn:CreateFontString(nil, "OVERLAY", "FSKFontNormal")
    ...
    frame.cancelBtn.text = frame.cancelBtn:CreateFontString(nil, "OVERLAY", "FSKFontNormal")
