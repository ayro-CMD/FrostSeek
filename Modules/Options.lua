...
local function UpdateCustomPreview(previewText)
    ...
    if customMessages and customMessages.enabled then
        local message = customMessages.template or "hello {class} {ilvl} {gs}gs {ench} dps or healer {keystone}"
        ...
        message = string.gsub(message, "{gs}", customMessages.showGs and tostring(gs) or "")
...
local function CreateCustomMessageTab(parent, scrollContent)
    ...
    templateBox:SetText(FrostSeekDB.LFG.customMessages and FrostSeekDB.LFG.customMessages.template or "hello {class} {ilvl} {gs}gs {ench} dps or healer {keystone}")
    ...
    resetBtn:SetScript("OnClick", function()
        FrostSeekDB.LFG.customMessages.template = "hello {class} {ilvl} {gs}gs {ench} dps or healer {keystone}"
