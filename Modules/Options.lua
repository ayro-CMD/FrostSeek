...
local SETTINGS_CATEGORIES = {
    ...
    { id = "activityfilter", name = "Activity Filter", icon = "Interface\\Icons\\INV_Misc_Spyglass_02", settings = {
        { type = "header", id = "activityFilterHeader", name = "Activity Filter", desc = "Choose which dungeons, raids and activities appear in LFG messages and popups. Uncheck items you are NOT interested in." },
