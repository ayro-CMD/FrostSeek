...
local SETTINGS_CATEGORIES = {
    { id = "general", name = "General", icon = "Interface\\Icons\\INV_Misc_Book_09", settings = {
        ...
        { type = "checkbox", id = "minimapButton", name = "Show Minimap Button", desc = "Show the FrostSeek minimap button", default = true, getter = function() return FrostSeekDB.Settings.minimapButton end, setter = function(v) FrostSeekDB.Settings.minimapButton = v local mb = _G["FrostSeekMiniMapButton"]; if mb then mb:SetShown(v) end end },
