...
-- ==================== ASSICURA STRUTTURA PREDEFINITA ====================
...
-- Assicura che i nuovi campi LFM esistano (per chi aggiorna)
...
miniButton:SetNormalTexture(ICON_BASE .. "default.tga")
